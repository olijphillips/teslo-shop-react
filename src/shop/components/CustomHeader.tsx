...
export const CustomHeader = () => {
  ...
  const handleSearch = (evento: React.KeyboardEvent<HTMLInputElement>) => {
    if (evento.key !== "Enter") return; // si esta typeando dejelo terminar
    ...
    setSearchParams(newSearchParams); //limpia los searchParams
  };
